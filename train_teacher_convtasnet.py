...
# Most of this is taken from: https://github.com/JusperLee/Conv-TasNet/blob/master/Conv_TasNet_Pytorch/Conv_TasNet.py
...
def select_norm(norm, dim):
    if norm not in ['gln', 'cln', 'bn']:
        if dim != 3:
            raise RuntimeError("Some class accept 3D tensor as input")
